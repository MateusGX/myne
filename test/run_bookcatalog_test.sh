...
BUILD_DIR="$ROOT_DIR/build/bookcatalog"
BINARY="$BUILD_DIR/BookCatalogTest"
SIM_DIR="$ROOT_DIR/.pio/libdeps/simulator/simulator/src"

mkdir -p "$BUILD_DIR"

SOURCES=(
  "$ROOT_DIR/test/bookcatalog/BookCatalogTest.cpp"
  "$ROOT_DIR/lib/DataStore/books/BookCatalog.cpp"
