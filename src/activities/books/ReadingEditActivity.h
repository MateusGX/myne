...
class ReadingEditActivity final : public Activity {
 ...
 public:
  explicit ReadingEditActivity(GfxRenderer& renderer, MappedInputManager& mappedInput,
                               PhysicalBook book, Reading reading)
      : Activity("ReadingEdit", renderer, mappedInput),
        book(std::move(book)),
